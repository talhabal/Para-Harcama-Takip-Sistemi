            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading"> 
                        <i class="fa fa-tags" ></i> Kart İşlemleri
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        	<center>
                                            <a href="kart_duzenle.php?hesap_id=<?php echo $row["hesap_id"]; ?>">
                                            <button class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Düzenle</button></a> 
                                            <a href="islem.php?kartsil_id=<?php echo $row["hesap_id"]; ?>">
